...
async function seedData() {
  try {
    ...
    const subjects = [
      ...
      { id: 'igbo', name: 'Igbo', exam_bodies: ['JAMB', 'WAEC', 'NECO', 'NABTEB'], is_compulsory: false },
      { id: 'hausa', name: 'Hausa', exam_bodies: ['JAMB', 'WAEC', 'NECO', 'NABTEB'], is_compulsory: false },
      { id: 'yoruba', name: 'Yoruba', exam_bodies: ['JAMB', 'WAEC', 'NECO', 'NABTEB'], is_compulsory: false },
